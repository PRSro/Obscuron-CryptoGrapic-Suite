...
PYBIND11_MODULE(_obscuron_core, m) {
    ...
    m.def("custom_rot", [](const std::string &a, int add) {
        std::string out; custom_rot(const_cast<std::string&>(a), add, out); return out;
    }, py::arg("text"), py::arg("shift"));
    m.def("rot13", [](const std::string &a) {
        std::string out; rot13(const_cast<std::string&>(a), out); return out;
    });
    ...
    m.def("keyboard_shift", [](const std::string &a, int n, bool encrypt) {
        std::string out; keyboard_shift(const_cast<std::string&>(a), out, n, encrypt); return out;
    }, py::arg("text"), py::arg("rows"), py::arg("encrypt") = true);

    // ── historical_ciphers ──

    m.def("atbash", [](const std::string &a) {
        std::string out; atbash(const_cast<std::string&>(a), out); return out;
    });
    m.def("caesar", [](const std::string &a) {
        std::string out; caesar(const_cast<std::string&>(a), out); return out;
    });
